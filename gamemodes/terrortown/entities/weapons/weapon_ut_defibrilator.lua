...
if CLIENT then
	SWEP.PrintName = "Undertaker Defibrillator"
	SWEP.Slot = 7


	SWEP.EquipMenuData = {
		type = "item_weapon",
		name = "Undertaker Defibrillator",
		desc = "Rescurrect people to become part of the Undertakers"
	}
...
function SWEP:HandleRespawn()
	local ply = self.TargetPly


	ply:Revive(0, function(p)
		p:UpdateRole(ROLE_UNDERTAKER, TEAM_UNDERTAKER)
		p:SetDefaultCredits()
		SendFullStateUpdate()
	end,
	function(p)
